...
title: "TIME"
source: dokuwiki
source_path: "sites:termiwiki:time"
created: 2023-01-02
tags:
  - "termisoc"
  - "projects"
...
It temporarily ran on Ford before it died. 

---

 TermiSoc Integrated Messaging Environment
...
- a novel protocol
- server application - to run on Linux
- client application - to be ported to Windows (and depending on demand Linux and Mac OS)

The services you can expect from the system are:
- public meeting rooms
- private meeting rooms
- discussion forums

The team have now collected a substantial list of user requirements and is moving into the technical planning/specification phase of the project.

If you are interested in the development of the project or would like to get involved with beta testing then please contact the team's Project Manager at ryan.smith2@students.plymouth.ac.uk. 
