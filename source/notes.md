---
title: "2006 - Notes - about us"
source: dokuwiki
source_path: "sites:termiwiki:notes"
created: 2023-01-03
---
# About Us

Termisoc is the University of Plymouth Computing Media Society. We have been established since circa 1994 and offer a range of facilities to our members - see our Services page for details.
What we do

We run weekly tutorials in the Babbage building, on a wide range of computing subjects. Previous tutorials have included introductions to HTML and PHP programming and to the Linux and Macintosh operating systems. Check out our calendar for upcoming events.

As well as that, we have many, many socials, from trips down the pub to bowling, to pool competitions at Rileys, as well as regular expeditions to the cinema and not-so-regular expeditions to, say, London. Again, check out the calendar for upcoming events - this term we've got a cinema trip planned every Wednesday as well as other socials planned for Thursdays and the usual trip to the Union after the tutorials. Come along - you won't regret it, and there may be pizza.
...
Meet the exec
	...
	Rich Jeffery [him](how_and_why_to_encrypt_your_email.md)
El Presidente and leader of a killer robot race.
	Skippy McGaw [him](how_and_why_to_encrypt_your_email.md)
Secretary, CamCrew manager and all round kinky person.
	Chris Morris [him](how_and_why_to_encrypt_your_email.md)
Our music-producing, breakdancing, caffeine-fueled treasurer.
	Ben A'Lee [him](how_and_why_to_encrypt_your_email.md)
The gothic broomstick Head Tech Officer, in eternal war with Skippy.
	Seth Kneller [him](how_and_why_to_encrypt_your_email.md)
Our shiny new Safety Officer, who is yet to cause an accident. Don't worry, Seth, you will.
	Dan Cosser [him](how_and_why_to_encrypt_your_email.md)
Our ATO, who avoids hard work at all costs.
---
Changed between 01 Jan - 30 Apr 2007  

Meet the exec
	Rich Jeffery [him](how_and_why_to_encrypt_your_email.md)
El Presidente and leader of a killer robot race.
	Ben A'Lee [him](how_and_why_to_encrypt_your_email.md)
The gothic broomstick Secretary/Head Tech Officer, in eternal war with Skippy.
	Chris Morris [him](how_and_why_to_encrypt_your_email.md)
