...
title: "Tutorials"
source: dokuwiki
source_path: "sites:termiwiki:tutorials"
created: 2023-01-01
tags:
  - "termisoc"
  - "relation"
...
- [Stanley](TermiPeople/alex.md) ran a HTML tutorial sometime in October/November 1996 

## Tutorials in 1997/98
- [Powell](TermiPeople/jeff_powell.md) (with backup from the rest of the TermiExec) ran a welcome to TermiSoc session for all the members in one of the Babbage lecture theatres.
- [Childs](TermiPeople/ross_childs.md) ran a Unix tutorial titled Really Groovy Unix Notes
...
Tutorial : 1
Date : 2007-10-08
Tutor : Rich Jeffery and Dan Cosser
What's it about?
...
Join the TermiSoc crew as we sort out all your accounts, tell you how to use all our services and explain how to set up a basic space for yourself (using Wordpress). Followed by drinks.
Resources
...
Tutorial : 2
Date : 2007-10-15
Tutor : Ben A'Lee, Rich Jeffery and Dan Cosser
What's it about?
...
At the moment, our choices will be: Ruby, Python, C# and Brainf*ck (and possibly Chef and all the other exceptionally odd languages).
...
Gem teaches people how to use Blender.
...
The functional language Lisp has long been hailed as a wonderful language, but is comparatively rarely used outside of academia. A large part of this maybe down to the fact that it is completely alien to programmers raised in C, Java or VB. In this tutorial, Dan will explain the concepts behind Scheme, a Lisp variant that has many followers.
Resources
