...
status: active
subject: "TermiSoc person-by-person archaeology — batch 1"
date: 2026-09-17
source_type: web-archaeology
---

# TermiSoc person-by-person archaeology — batch 1

## Source

A targeted public-web search was conducted on 2026-09-17 using the firsthand-identified TermiSoc member list recorded in `research/sources/2026-09-17_firsthand_termisoc_member_identifications.md` as the search anchor. Searches included exact names, Plymouth, University of Plymouth, computing, TermiSoc/Termisoc, and where useful personal websites or professional profiles.

This record captures documentary evidence found during this pass. The project owner's firsthand identification remains a separate evidence class and is not silently upgraded by matching names online.

## Direct evidence

### Ben A'Lee

A 2006 FreeBSD mailing-list message by Benjamin A'Lee identifies the author as `Benjamin A'Lee`, gives `benalee.co.uk` as his homepage, and explicitly signs off with `Termisoc Tech Officer: http://termisoc.org/`. This is strong contemporaneous documentary evidence linking Ben A'Lee to TermiSoc and specifically to the Tech Officer role.

Source: FreeBSD questions mailing list, 18 February 2006.
...
Ross Bearman's LinkedIn profile states that he studied at the University of Plymouth from 2008–2011 and explicitly lists `TermiSoc` among his activities and societies. The same profile says he studied Computer Science for his first two years and specialised in software development in his final year.

Source: Ross Bearman LinkedIn profile.

URL: https://uk.linkedin.com/in/rossbearman

A current Freeway Projects profile identifies Ross Bearman as a Senior Developer & Project Manager and describes extensive software development, systems-management and hosting-infrastructure work. This is later-career corroboration of the same professional identity, not TermiSoc evidence.

Source: Freeway Projects, About Us.

URL: https://freewayprojects.com/about-us/

Confidence: **High** for TermiSoc association and University of Plymouth chronology.

### Nick Charlton

Nick Charlton's LinkedIn profile states that he attended the University of Plymouth from 2009–2013 and explicitly lists `Safety Officer (2010-2011) & Tech Officer (2011-2013), TermiSoc (University of Plymouth Computing Society)`.

Source: Nick Charlton LinkedIn profile.

URL: https://uk.linkedin.com/in/nickcharlton

Nick also retains a personal website with two directly TermiSoc-related posts from 2011:

- `The Digital Peninsula's First Web Unconference`, published 7 March 2011. The post says he gave a talk about TermiSoc at the University and describes TermiSoc's Monday Workspace evenings.
- `TermiSoc Hack Weekend 2011`, published 8 February 2011. The post documents a TermiSoc hack weekend covering games, Arduino projects, open data, algorithms, natural-language processing, mobile development, HTML5/CSS/JavaScript, Python and Git. It also says sessions were to be discussed on the TermiSoc mailing list.
...
Joe Earlam's LinkedIn profile states that he attended the University of Plymouth from 2011–2015 and lists `Termisoc (computing society)` among his activities and societies. His profile also identifies electronics/embedded-systems coursework and a 2015 final project.

Source: Joe Earlam LinkedIn profile.

URL: https://uk.linkedin.com/in/joe-earlam-95708784

Confidence: **High** for TermiSoc association and University of Plymouth chronology.

### Siddharth Vadgama

Siddharth Vadgama's LinkedIn profile states that he attended the University of Plymouth from 2009–2014 and explicitly lists `TermiSoc: Computing Society - Chairman` among his activities and societies.

Source: Siddharth Vadgama LinkedIn profile.
...
## TermiHouse relevance

No direct TermiHouse 1 evidence was found in this batch. The strongest next searches should combine the known people with `TermiHouse`, `Termi House`, house names/addresses, and archived personal pages. Nick Charlton's contemporaneous TermiSoc material and Ben A'Lee's historical personal-site footprint are particularly promising routes into the wider web archive.

## Open questions

1. Can archived copies of Ben A'Lee's `benalee.co.uk` site expose TermiSoc pages, photographs, committee lists or house information?
2. Can Nick Charlton's older site material or linked documents identify other named members, committee officers or locations?
3. Can Ross Bearman's historical personal/blog material provide additional TermiSoc or social-group evidence from 2008–2011?
4. Can Joe Earlam's 2011–2015 period be linked to specific TermiSoc events or projects?
5. Can Siddharth Vadgama's chairmanship be dated more precisely from contemporary TermiSoc material?
6. Can the unresolved people be disambiguated through archived University of Plymouth pages, personal websites, Git repositories, photographs or society/event records?
7. Can any of the identified people be linked to TermiHouse 1 through contemporaneous evidence rather than inference?

## Publication impact

These findings should feed the people register and individual person pages where appropriate. Public documentary evidence should be cited separately from the project owner's firsthand identifications. No unresolved person should be upgraded to a confirmed TermiSoc member solely from a same-name search result.
...
- Ed McCaghan, Georgie Aggett, Stewart Starbuck, Chris Morris, Chris Hunt — **Unverified** for TermiSoc evidence from this batch.
