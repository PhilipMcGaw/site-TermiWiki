---
title: "Alex McLean — TermiSoc lead investigation"
date: 2026-09-17
status: research
confidence: medium
---
...
User-supplied Facebook profile lead for **Alex McLean**, followed by web archaeology on possible Plymouth people of that name. Facebook profile URL: https://www.facebook.com/share/1DgsHefbDK/?mibextid=wwXIfr

Retrieval date: 2026-09-17.

## Direct evidence

- A scholarly history of live coding states that **Alex McLean studied BSc Computing at the University of Plymouth**, where he met Adrian Ward, who was studying Media Lab Arts. It places both students at Plymouth and describes McLean as frustrated by the lack of creative opportunity in his applied computing course. Source: https://livecodingbook.toplap.org/book/
...
The current search results also surface a different **Alex McLean in the Greater Plymouth Area**, with a public LinkedIn result associated with HellermannTyton United Kingdom. Source: https://uk.linkedin.com/in/alex-mclean-19ab29192

The search evidence does not establish that this current Greater Plymouth Area profile is the same person as the University of Plymouth BSc Computing student / live-coding researcher described above. The user-supplied Facebook share URL cannot be independently inspected here sufficiently to make that identification.

Therefore there are currently **two possible identity tracks**:

1. **Alex McLean — University of Plymouth BSc Computing / slub / Perl / live coding**, historically relevant to Plymouth computing around 1999–2001.
2. **Alex McLean — current Greater Plymouth Area / HellermannTyton profile**, whose historical connection to the University of Plymouth and TermiSoc is not established by the sources found in this pass.

Do not merge these identities without a further bridge.
...
- Did the live-coding Alex McLean belong to TermiSoc, or was his Plymouth computing activity independent of the society?
- Did he use TermiSoc facilities, hosting, mailing lists, or Unix infrastructure?
- Is there any surviving 1990s Plymouth/TermiSoc material authored by McLean?
...
Keep as a **lead only**. It may eventually become a TermiSoc person record if independent evidence of society involvement is recovered. Do not currently list Alex McLean as a confirmed TermiSoc member.
