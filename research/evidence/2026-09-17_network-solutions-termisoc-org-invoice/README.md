...
subject: "Network Solutions invoice for termisoc.org registration"
date: 2026-09-17
source_type: user-supplied-document-image
confidence: High
---

# Network Solutions invoice for termisoc.org registration

## Source and retrieval

The user supplied a Facebook-hosted scan on 17 September 2026 and identified it as the original paper invoice for the first registration of `termisoc.org`:

<https://scontent-lhr11-1.xx.fbcdn.net/v/t39.30808-6/468669136_10161212914036448_2872446516356565883_n.jpg>
...
None. The invoice is intentionally not added to the published source vault.
