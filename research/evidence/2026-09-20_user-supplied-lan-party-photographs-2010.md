...
- The project maintainer identifies **Gemma Peter** in `DSC_3595 2.jpeg` and `DSC_3596.jpeg`, and **Aimee Spencer** in `DSC_3599 2.jpeg`. These are maintainer-supplied identifications and are not inferences from visual resemblance; no additional participant identities are established by this update.
